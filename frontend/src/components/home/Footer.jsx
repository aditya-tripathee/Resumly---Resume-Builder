...
const Footer = () => {
   return (
        <>
            ...
            <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-gray-100 pt-10 mt-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                    <div className="sm:col-span-2 lg:col-span-1">
                        <a className='flex items-center'>
                          <img src='/resumly.png' className='w-10'/> 
                          <span className='text-2xl pl-1 text-pink-500 font-bold'>Res</span>
                          <span className='text-2xl text-blue-700 font-bold'>umly</span> 
                        </a>
                        <p className="text-sm/7 mt-6">
                       Resumly is a free and easy-to-use resume builder that lets you create professional, recruiter-ready resumes in minutes. Choose from modern templates, customize sections effortlessly, and download your resume instantly as a high-quality PDF.</p>
                    </div>
                ...
                <p className="py-4 text-center border-t mt-6 border-slate-200">
                    Copyright 2025 © Resumly All Right Reserved.
                </p>
            </footer>
        </>
    );
